...
const App = () => {
  ...
  const analysis = useMemo(() => {
    ...
    if (is3231) {
      ...
      // 霸王條款：只有在建議買入時（>45分）才需要「逆勢」警告
      if (maSlope < 0 && totalBuyScore > 45) {
      ...
      // 霸王條款：只有在建議買入時（>40分）才需要「逆勢」警告
      if (maSlope < 0 && totalBuyScore > 40) {
        buySignal = { ...buySignal, text: buySignal.text + ' (逆勢)' };
      }
    }
